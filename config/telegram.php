...
return [
    ...
    */
    'bots' => [
      env('NOTIFICATION_TELEGRAM_BOT_NAME') => [
        'username' => env('NOTIFICATION_TELEGRAM_BOT_NAME'),
        'token' => env('NOTIFICATION_TELEGRAM_BOT_TOKEN', ''),
        'certificate_path' => env('NOTIFICATION_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
        'webhook_url' => env('NOTIFICATION_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
        'commands' => [
